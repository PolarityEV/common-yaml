...
#define VCU_I2C_DIAGNOSTIC_CONTROL     (0x14)  ///< Diagnostic control overrides (WRITE: 9 bytes total [command + 8 data: flags[2], waterPumpDuty, reserved[5]]; RESPONSE: 1 byte: 0=OK, 1=Error) [NEW v7.0: Advanced diagnostic testing]
